...
public interface IWorkspaceService
{
    ...
    Task<List<GetWorkspaceDto>> GetArchiveAsync(string AppUserId);
    Task UpdateArchive(string AppUserId,Guid WorkspaceId);

    //Global workspace search
    Task<GetGlobalSearch> GetGlobalSearch(string searchTerm);
}
