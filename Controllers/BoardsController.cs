...
public class BoardsController : ControllerBase
{
    ...
    [HttpPut("[action]")]
    public async Task<IActionResult> UpdateBoardIsArchive(string AppUserId, Guid BoardId)
    {
        await _boardsService.UpdateArchive(AppUserId, BoardId);
        return Ok();
    }
    ...
    [HttpGet("[action]")]
    public async Task<IActionResult> GetBoardInUsers(Guid BoardId)
    {
        var boardUsers = await _boardsService.GetBoardAllUser(BoardId);
